...
public class LinkedQueue<T> {
    ...
    public T dequeue() {
        if (size == 0) {
            throw new NoSuchElementException("The queue is empty. Unable to dequeue elements.");
        }
    ...
    public T peek() {
        if (size == 0) {
            throw new NoSuchElementException("The queue is empty. Unable to peek elements.");
        }
        return head.getData();
    }
